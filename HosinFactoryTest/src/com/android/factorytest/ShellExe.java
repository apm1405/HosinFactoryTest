...
public class ShellExe {
	 ...
	 * 
	 * @param command
	 *            Command string need to execute
	 * @return Result
	 * @throws IOException
	 *             Throws when occurs #IOException
	 */
	...
	public static int execCommand(String[] command) throws IOException {
		...
		//	Xlog.i(TAG,
			//		"exe shell command InterruptedException: " + e.getMessage());
			sResultBuilder.append(ERROR);
			...
			//		Xlog.w(TAG,
				//			"close reader in finally block exception: "
					//				+ e.getMessage());
				}
			}
		}
